...
export default function WizeCamp() {
  ...
  return (
    <>
      <div className={`fixed top-[100vh] min-h-[calc(100vh-4rem)] w-full left-0 right-0 flex justify-center duration-500 z-10 transition `}>
        <div className="bg-white mt-10 w-[85vw] h-[80vh] flex flex-col items-center justify-center shadow-lg rounded-lg">
          ...
          <button className="relative text-white font-bold top-[30vh] p-4 border-x-primary-foreground border-4 rounded-xl bg-primary">
            CLOSE FORM
          </button>
        </div>
      </div>
