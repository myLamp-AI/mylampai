...
import pbimg from '../../../public/pbimg.png'
...
const VideoPage = () =>{
    ...
    return (
        <div className="h-screen w-screen flex flex-col bg-[#E8E2F4]">
            ...
            <div className="h-full flex flex-col ">
                <div className="flex flex-row gap-8 justify-center h-14 w-screen items-center">
                    {
                ...
                <div className="h-2/3 flex">
                    <div className="flex items-center"><Image src={arrow1} alt="arrow" onClick={prevSlide} className="h-9 w-5 ml-14 "/></div>
                    ...
                    <div className="flex items-center"><Image src={invarrow} alt="invarrow" className="h-9 w-5 mr-14" onClick={nextSlide}/></div>
                </div>
                            ...
                            <div className="flex flex-row">
                                <div className="ml-10 flex flex-row gap-4">
                                    <div className="w-24 h-24 relative ">
                                        <div><Image src={pbimg} alt="pause" className="h-24 w-24"/></div>
                                        <svg className="absolute inset-0 transform rotate-180" viewBox="0 0 100 100">
                                            <circle className="progress-ring" cx="50" cy="50" r="40" fill="transparent" stroke="#ffffff"stroke-width="8"></circle>
                                            <circle className="progress-ring" cx="50" cy="50" r="40" fill="transparent" stroke="#8C52FF"stroke-width="8" stroke-dasharray="251.2" stroke-dashoffset="251.2"></circle>
                                        </svg>
                                    </div>
